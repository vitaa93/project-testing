...
// Put executes http PUT request with the given body & headers.
// The supported data types for body are:
// - string
// - []byte
// - struct/map/slice : will be marshalled to JSON
...
// PutJSON executes http PUT request with the given body & headers and parse the json response body
// into the given data.
// The supported data types for body are:
// - string
// - []byte
